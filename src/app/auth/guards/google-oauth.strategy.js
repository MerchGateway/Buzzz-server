...
var GoogleOauthStrategy = /** @class */ (function (_super) {
    __extends(GoogleOauthStrategy, _super);
    function GoogleOauthStrategy(configService, authService, usersService) {
        var _this = _super.call(this, {
            clientID: configService.get('oauth.googleClientId'),
            clientSecret: configService.get('oauth.googleClientSecret'),
            callbackURL: configService.get('appUrl') + 'v1/auth/google/redirect',
            scope: ['email', 'profile']
        }) || this;
    ...
    GoogleOauthStrategy.prototype.validate = function (_accessToken, _refreshToken, profile) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.authService.findOauthUser(user_1.IdentityProvider.GOOGLE, id)];
                    case 1:
                        user = _a.sent();
                        if (!!user) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.usersService.create({
                                identityProvider: user_1.IdentityProvider.GOOGLE,
