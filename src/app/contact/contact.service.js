...
var ContactService = /** @class */ (function () {
    ...
    ContactService.prototype.sendMessage = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var config, message, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        config = (0, configuration_1["default"])();
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
    ...
    ContactService.prototype.getAllMessages = function () {
        return __awaiter(this, void 0, void 0, function () {
            var messages, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.contactRepository.find()];
                    case 1:
                        messages = _a.sent();
    ...
    ContactService = __decorate([
        ...
        __param(1, (0, common_1.Inject)(constant_1.EMAIL_PROVIDER))
    ], ContactService);
