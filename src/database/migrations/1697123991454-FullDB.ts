...
export class FullDB1697123991454 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`design\` (\`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`id\` varchar(36) NOT NULL, \`published\` tinyint NOT NULL DEFAULT 0, \`design_data\` text NOT NULL CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci, \`contributors\` text NULL, \`images\` text NULL, \`texts\` text NULL CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci, \`user_id\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
