...
export class AddDefaultColorToOrderColorAndCartEnum1706626223553
  implements MigrationInterface
{
  name = 'AddDefaultColorToOrderColorAndCartEnum1706626223553';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`order\` CHANGE \`color\` \`color\` enum ('#002366', '#ffffff', '#808080', '#333333', '#ff0005', '#ff8c00', 'Green', 'Red', 'White', 'Blue', 'Orange', 'Black', 'Grey', 'Brown', 'Pink', 'Purple', 'Ash') NOT NULL DEFAULT '#ffffff'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`colors_and_sizes\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`colors_and_sizes\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`order\` CHANGE \`color\` \`color\` enum ('#ffffff', '#808080', '#333333', '#ff0005', '#ff8c00', 'Green', 'Red', 'White', 'Blue', 'Orange', 'Black', 'Grey', 'Brown', 'Pink', 'Purple', 'Ash') NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
