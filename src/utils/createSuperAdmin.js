...
var createSuperAdmin = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                parseSuperAdmin = superadminJson;
                return [4 /*yield*/, user_entity_1.User.findOne({ where: {
                            role: general_1.Role.SUPER_ADMIN
                        } })];
            case 1:
                superadmin = _a.sent();
                if (!!superadmin) return [3 /*break*/, 3];
                newSuperAdmin = user_entity_1.User.create(__assign(__assign({}, parseSuperAdmin), { role: general_1.Role.SUPER_ADMIN }));
                return [4 /*yield*/, user_entity_1.User.save(newSuperAdmin)];
            case 2:
                newlyCreatedAdmin = _a.sent();
