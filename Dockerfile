...
ENV OAUTH_GOOGLE_ID=google client id
ENV OAUTH_GOOGLE_SECRET=google client secret
ENV OAUTH_TWITTER_CONSUMER_KEY=twitter consumer key
ENV OAUTH_TWITTER_CONSUMER_SECRET=twitter consumer secret

ENV SENDGRID_API_KEY=sendgrid api key
ENV FROM_EMAIL=from email
ENV PORT=5000
# firebase
